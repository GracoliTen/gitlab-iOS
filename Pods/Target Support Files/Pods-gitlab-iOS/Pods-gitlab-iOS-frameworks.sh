...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-gitlab-iOS/DateTools.framework"
  install_framework "Pods-gitlab-iOS/Eureka.framework"
  ...
  install_framework "Pods-gitlab-iOS/XNGMarkdownParser.framework"
fi
